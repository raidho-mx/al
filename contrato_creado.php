<?php include'header.php';?>
	<section class="bg_white message_block_fixed">
		<div>
			<p><b>Almirant</b> <span>funciona como un intermediario para que manejes tus 
			contratos de la forma más fácil con tus contratos.</span> Si quieres ver 
			el contrato en su formato tradicional, <a href="#">haz click aqui.</a></p>
		</div>
	</section>
		...
		<div class="create_contract bg_white">
			...
			<div class="fixed_btn">
				...
				<div><a href="contratos.php"><img src="img/guardar.svg"></a>
					<div class="helper">Guardar Archivo</div>
				</div>
			</div>
			...
			<div class="wrapper">
				...
				<div>
					...
					<div class="txt">
						<p>Mis servicios tienen un valor de <b>$75,000.00 mxn</b> + I.V.A. 
							y serán cubiertos en <b>4 pagos</b> de <b>25% — Lauro</b> va a pagar 
